...
//                        eq(ProjectItem.VENDOR_COLUMN_NAME),
// eq(ProjectItem.VendorNameIndex.class)))
...
//
//            when(projectItemStore.getItem(projectId)).thenThrow(new RuntimeException("not
// found"));
//
...
// newDao.getProjectItemsForVendor(vendorName));
//    }
//
//    @Test
