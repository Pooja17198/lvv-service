...
class BadLinksServiceTest {
    ...
    void test_whenStale_prunesClosedTickets_fetchesNewTickets_andPublishes() {
        ...
        assertTrue(
                body.contains(
                        "New Link Down Alert(s) in -- "
                                + expectedBuilding
                                + " -- 1 more link(s) are down"));
        assertTrue(body.contains("Generated Time (UTC): "));
        assertTrue(body.contains("https://jira-sd.mc1.oracleiaas.com/browse/DO-NEW-42"));
